...
function StudyPageClient({ id, listId, mode }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudyPageClient.useEffect": ()=>{
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && words.length > 0) {
                const savedProgress = localStorage.getItem(`bunny_words_progress_${id}_${listId}`);
                if (savedProgress) {
                    try {
                        const { currentIndex: savedIndex, correctCount: savedCorrect, wrongCount: savedWrong } = JSON.parse(savedProgress);
                        if (typeof savedIndex === 'number' && savedIndex < words.length) {
                            setCurrentIndex(savedIndex);
                            setCorrectCount(savedCorrect || 0);
                            setWrongCount(savedWrong || 0);
                        }
                    } catch (e) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudyPageClient.useEffect": ()=>{
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && words.length > 0) {
                ...
                localStorage.setItem(`bunny_words_progress_${id}_${listId}`, JSON.stringify(progressData));
            }
        }
    }["StudyPageClient.useEffect"], [
        currentIndex,
    ...
    const handleChoiceSubmit = (optionIndex)=>{
        ...
        if (selectedText === currentWord.definition) {
            setCorrectCount(correctCount + 1);
        } else {
            setWrongCount(wrongCount + 1);
        }
...
_s(StudyPageClient, "yF/UCtDIPJ/hUntmQWlvAruw2Ys=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_bunny-words-homepage_3ff151ea._.js.map