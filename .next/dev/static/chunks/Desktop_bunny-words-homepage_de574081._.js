...
function WordbookList({ wordbookId, lists }) {
    ...
    const loadStats = ()=>{
        ...
        lists.forEach((list)=>{
            ...
            // Get SRS progress
            const progress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$lib$2f$utils$2f$srs$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getListProgress"])(wordbookId, sectionId);
            const srsStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$lib$2f$utils$2f$srs$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getListStats"])(progress, words.length);
            stats[list.id] = {
...
"[project]/Desktop/bunny-words-homepage/app/wordbook/[id]/wordbook-stats.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WordbookStats({ wordbookId, totalWords, lists }) {
    _s();
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        totalWords,
        learnedWords: 0,
        dueForReview: 0,
        starredWords: 0
    ...
    const calculateStats = ()=>{
        ...
        lists.forEach((list)=>{
            const sectionId = `${wordbookId}_list_${list.id}`;
            const progress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$lib$2f$utils$2f$srs$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getListProgress"])(wordbookId, sectionId);
            const listStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$lib$2f$utils$2f$srs$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getListStats"])(progress, list.endIndex - list.startIndex);
            learnedWords += listStats.learned;
            dueForReview += listStats.dueForReview;
        });
        // Get starred words count for this wordbook
        const allStarred = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$bunny$2d$words$2d$homepage$2f$lib$2f$utils$2f$starred$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStarredWords"])();
...
_s(WordbookStats, "7TiiHJ3PiVILuBuWHixOUf8xVGE=");
_c = WordbookStats;
var _c;
__turbopack_context__.k.register(_c, "WordbookStats");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_bunny-words-homepage_de574081._.js.map